...
import { Divider, Stack, Box, Typography, Link, IconButton, Menu, MenuItem } from '@mui/material'
...
const DocMsg = ({ el }) => {
    ...
    return (<Stack direction={"row"} justifyContent={el.incoming ? "start" : "end"} >
        <Box
            ...
            <Stack spcaing={2}>
                <Stack direction={"row"} p={2} spacing={3} alignItems={"center"} sx={{ backgroundColor: theme.palette.background.paper, borderRadius: 1 }}>
                    <Image size={48} />
                ...
                <Stack spacing={2}>
                    <Stack p={2} spacing={3} alignItems={"start"} sx={{ backgroundColor: theme.palette.background.paper, borderRadius: 1 }} >
                        ...
                        <Stack spacing={2}  >
                            ...
                            <Typography variant={"subtitle2"} sx={{ color: theme.palette.primary.main }} to={"//https://www.youtube.com"} component={Link} >www.youtube.com</Typography>
                        </Stack>
    ...
    return (
        <Stack direction={"row"} justifyContent={el.incoming ? "start" : "end"} >
            <Box
                ...
                <Stack spacing={2}>
                    <Stack
                        p={2} direction={"column"} alignItems={"center"}
                        sx={{
                            backgroundColor: theme.palette.background.paper, borderRadius: 1
                        }}>
                        <Typography variant='body' color={theme.palette.text} >{el.message} </Typography>
                    </Stack>
    ...
    return (
        <Stack direction={"row"} justifyContent={el.incoming ? "start" : "end"}>
            <Box
                ...
                <Stack spacing={1}>
                    <img src={el.img} alt={el.msg} style={{ maxHeight: 210, borderRadius: "10px" }} />
                    <Typography variant='body2' color={el.incoming ? theme.palette.text : "#fff"}>
                        {el.message}
                    </Typography>
                </Stack>
